...
const SocialLinks = () => {
  return(
    <div className={style.socialLinksContainer}>
      <a href="https://twitter.com/Elrond_Mafia" target={"_blank"} className={style.socialLink}>
      ...
      <a href="https://discord.gg/elrondmafia" target={"_blank"} className={style.socialLink}>
